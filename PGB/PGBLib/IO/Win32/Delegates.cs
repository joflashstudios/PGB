...
namespace PGBLib.IO.Win32
{
    ...
    /// </summary>
    /// <param name="PendingBytes">The remaining size of the file to be copied, in bytes</param>
    ...
    /// <returns></returns>
    public delegate IOProgressResult IOProgressCallback(Int64 PendingBytes, Int64 ProcessedBytes, string sourceFile, string destinationFile);
}
